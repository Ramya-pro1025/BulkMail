...
function App() {
  ...
  function handlefile(event)
  {
    ...
    reader.onload = function(event) {
        ...
        const workbook = XLSX.read(data, { type: 'array' });  // Correct method: XLSX.read
        console.log(workbook);  // Log the workbook object
  ...
  return (
    ...
    <div className="bg-blue-400 flex flex-col items-center text-black px-5 py-3">
      <textarea onChange={handlemsg} value={msg} className="w-[80%] h-32 py-2 outline-none px-2 border border-black rounded-md" placeholder="Enter the E-mail text..."></textarea>
      ...
      <button onClick={send} className="mt-2 bg-blue-950 px-2 py-2 text-white font-medium rounded-md w-fit">{status?"Sending...":"Send"}</button>
